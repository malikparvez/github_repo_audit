...
task(:default) do
  puts("These rake tasks will make quick markdown dashboards of githug org checks that")
  puts("we want to keep private. Make sure you have a valid GitHub token or you'll be API")
